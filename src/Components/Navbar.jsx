...
const Navbar = () => {
  ...
  const sections = [
    ...
    { name: getTranslation('certifications', language), path: '/certifications' },
        ...
        <div className="flex justify-between items-center py-3 border-b border-gray-200">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-gray-700">+2 01065000130</span>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              {showContactDropdown && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-30 overflow-hidden">
                  <div className="p-4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-3">{getTranslation('contactInformation', language)}</h3>
                    ...
                    <div className="flex items-start space-x-3 mb-4">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-700">{getTranslation('address', language)}</p>
                        <p className="text-sm text-gray-600 mb-2">{contactInfo.address}</p>
                        <a 
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-700">{getTranslation('telFax', language)}</p>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-700">{getTranslation('customerService', language)}</p>
                          <p className="text-sm text-gray-600">{contactInfo.customerService}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-700">{getTranslation('email', language)}</p>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-700 mb-1">{getTranslation('workingHours', language)}</p>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <div className="px-3 py-2">
                  <h4 className="text-base font-medium text-gray-800 mb-2">{getTranslation('contactInformation', language)}</h4>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-600">{contactInfo.customerService}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-start space-x-2">
                      <svg className="h-4 w-4 text-orange-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <div className="text-gray-600">
                        <p className="font-medium">{getTranslation('workingHours', language)}:</p>
                        <p>{contactInfo.workingHours.weekdays}</p>
                        <p>{contactInfo.workingHours.saturday}</p>
                        <p>{contactInfo.workingHours.sunday}</p>
                      </div>
