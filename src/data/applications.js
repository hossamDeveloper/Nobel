...
export const applicationDetails = {
	...
	"Industrial Furnaces": {
		...
		fanDesigns: [
			...
			"Custom Airfoil",
			"Custom Backward Inclined",
			"Custom Backward Curved",
			"Custom Radial",
			"Custom Radial Tip",
		],
	},
	...
	"Mine and Tunnel Ventilation": {
		...
		materials: ["Carbon Steel", "Stainless Steel", "FRP"],
		fanDesigns: [
			"VXAP Axial Fans with inlet bell and diffuser",
			"AX-4700 and AX-4300 Axial Arr 3 Fans",
			"AX-4700 and AX-4300 Axial Arr 4 Fans",
